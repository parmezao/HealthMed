using HealthMed.Consultation.Infra.IoC;
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "HealthMed.Consultation.API",
        Version = "v1",
        Description = "API para gerenciamento de Consultas no sistema HealthMed"
    });
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "HealthMed.Consultation.API v1");
});
